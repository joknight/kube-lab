...
➜  kube-lab git:(lab) kubectl get svc
...
➜  kube-lab git:(lab) kubectl get namespace
NAME          STATUS    AGE
default       Active    55m
ingress       Active    6s
...
➜  kube-lab git:(lab) kubectl get pods -n ingress
NAME                               READY     STATUS    RESTARTS   AGE
...
➜  kube-lab git:(lab) kubectl get ingress -n ingress
...
➜  kube-lab git:(lab) kubectl get ingress
NAME            HOSTS               ADDRESS   PORTS     AGE
...
➜  kube-lab git:(lab) kubectl get svc -n ingress
NAME              TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)                        AGE
...
➜  kube-lab git:(lab) kubectl get all
